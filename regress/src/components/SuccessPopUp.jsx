...
const SuccessPopUp = ({ message }) => {
    ...
    return (
        <div className="fixed z-20 w-1/3 h-44 bg-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-2 border-primary-200 flex items-center justify-center rounded-lg">
